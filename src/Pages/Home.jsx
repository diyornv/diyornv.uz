...
const WORDS = ["Frontend & Uzinfocom Student", "Sammi Practicum Experience", "Ustudy Academy",];
const TECH_STACK = ["React", "Javascript", "Tailwind", "StyledComponents"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/diyornv" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/diyornv/" },
  { icon: Instagram, link: "https://www.instagram.com/diyor.nv" },
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/58753882-bb6a-49f5-a2c0-950eda1e135a/NLbpVsqGegK.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Creating Innovative, Functional and Websites
                </p>
